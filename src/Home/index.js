                        ...
                        <div className="container">
                            ...
                            {   
                                filterPoke.map((pokemon, index) => 
                                    <CardContainer key={index} className="col-sm-4 mt-5">
                                            ...
                                            <InfoContainer className="mx-lg-3">
                                                ...
                                                <TypesContainer className="row">
                                                    <PokemonType className="col-3 ms-3 rounded">{pokemon.data.types[0].type.name[0].toUpperCase() + pokemon.data.types[0].type.name.substring(1)}</PokemonType>
                                                    { pokemon.data.types[1]?.type.name && 
                                                        <PokemonType className="col-3 ms-2 rounded">{pokemon.data.types[1].type.name[0].toUpperCase() + pokemon.data.types[1].type.name.substring(1)}</PokemonType>    
                                                    }
                                                </TypesContainer>
                                            </InfoContainer>
                                    </CardContainer>
